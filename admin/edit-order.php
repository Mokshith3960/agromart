...
<head>
	...
	<title>Agromart - Edit Order</title>
                            ...
                            <div class="card p-3">
                                <form method="post">
                                    <?php
                                        ...
                                        left join products P on P.product_id=O.product_id where order_id=$id") or die(mysqli_error($con));
                                            ...
                                            ?>
                                                <script>
                                                    Swal.fire(
                                                    {
                                                        ...
                                                        window.location='view-orders.php';
                                                    });
                                                </script>
                                            <?php
                                        }
