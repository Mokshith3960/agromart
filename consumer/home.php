		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Consumer</strong> Dashboard</h1>
										...
										<div class="card">
											<div class="card-body">
												...
												<?php 
													...
													echo mysqli_num_rows(mysqli_query($con,"SELECT * from orders")); 
												?>
												</h1>
											</div>
										</div>										
									...
									<div class="col-3">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">
													<?php 
														echo mysqli_num_rows(mysqli_query($con,"SELECT * from payments"));
													?>
												</h1>
											</div>
										</div>										
