...
<head>
	...
	<title>Agromart - Notify Admin</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card p-3">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-6 mb-2">
                                            ...
                                            <input type="text" name="from" readonly class="form-control" value="<?php echo $_SESSION['consumer_email'] ?>" id="from">
                                        </div>
                                        <div class="col-6 mb-2">
                                            <label for="" class="form-label">To</label>
                                            <input type="text" name="to" readonly class="form-control" value="admin@gmail.com" id="to">
                                        </div>
                                        <div class="col-6 mb-2">
                                ...
                                <?php
                                    ...
                                    {
                                        $fromid=$_SESSION['consumer_id'];
                                        $from=$_SESSION['consumer_email'];
                                        $to=1001;
                                            ...
                                            ?>
                                                <script>
                                                    Swal.fire(
                                                    {
                                                        ...
                                                        window.location='notify-admin.php';
                                                    });
                                                </script>
                                            <?php
                                        }
