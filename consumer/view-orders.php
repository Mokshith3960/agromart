								...
								<table class="table table-bordered my-0">
									...
									<tbody>
										<?php
											...
											$query=mysqli_query($con,"SELECT f.farmer_name, p.product_name, o.invoice_number, o.amount, o.status from orders O 
											left join farmers F on O.farmer_id=F.farmer_id
											left join products P on P.product_id=O.product_id
                                            left join consumer C on c.consumer_id=P.consumer_id WHERE C.consumer_id=$id") or die(mysqli_error($con));
