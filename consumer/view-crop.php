		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>View Crops</strong></h1>
								...
								<table class="table table-bordered my-0">
									...
									<tbody>
										<?php
											...
											$query=mysqli_query($con,"SELECT F.farmer_name, c.crop_name, C.crop_description, 
											C.crop_initial_amount,C.crop_amount, C.image_location, C.crop_id FROM crops C
                                            left join farmers F on F.farmer_id=C.farmer_id") or die(mysqli_error($con));
										...
										<tr>
											...
											<td class="d-none d-xl-table-cell">
												<a href="./edit-crop.php?crop_id=<?php echo $row['crop_id']; ?>" class="btn btn-primary">Bid</a>
											</td>
										</tr>
										<?php
												$i++;
