...
<head>
	...
	<title>Agromart - Edit Crop</title>
                            ...
                            <div class="card p-3">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-2">
                                            ...
                                            <input type="text" name="name" required value="<?php echo $row['crop_name']; ?>" class="form-control" placeholder="Please Enter Name.." id="name">
                                        </div>
                                        <div class="col-6 mb-2">
                                            <label for="" class="form-label">Description</label>
                                            <textarea name="description" id="description" required class="form-control" placeholder="Please Enter Description.."><?php echo $row['crop_description']; ?></textarea>
                                        </div>
                                        <div class="col-6 mb-2">
                                        ...
                                        <div class="col-6 mb-2">
                                            <label for="" class="form-label">Amount</label>
                                            <input type="number" name="bidamount" value="<?php echo $row['crop_amount']; ?>" min="<?php echo $row['crop_amount']; ?>" readonly class="form-control" placeholder="Please Enter Amount.." id="bidamount">
                                        </div>
                                ...
                                <?php
                                    if(isset($_POST['submit']))
                                    {
                                        ...
                                        $sql="UPDATE crops set crop_name='$name',crop_description='$description' where crop_id=$id ";
